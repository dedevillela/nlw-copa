...
> The NLW is a free online event to take you to the next level building an exclusive,never seen before complete application. Extensive use of **Next JS**[^nextjs] and **Native Base**[^nativebase].
